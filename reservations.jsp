...
<!--Displays past reservations with new ones

    button to go back to home page

    top part displays, the previous flights

    bottom part displays upcomning flights and button to cancel them. -- (cancelReservations.jsp)
-->
